...
parser.add_argument("--kegg_json", help=".json file from KEGG", type =str, default="/mnt/netapp1/Store_CSIC/home/csic/eyg/fhc/Databases/KOfam/ko00001.json")
parser.add_argument("--skip_kegg", help="Flag to skip KEGG search and parsing", type = bool, default=False)
parser.add_argument("--uniref_db", help="The UniRef100 Database formated for DIAMOND", type =str, default="")
