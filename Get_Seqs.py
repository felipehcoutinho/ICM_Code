...
parser.add_argument("--matched_output_sequences", help="File to write matched output sequences", default='Passed_Sequences.fasta',type=str)
parser.add_argument("--unmatched_output_sequences", help="File to write unmatched output sequences", default='Passed_Sequences.fasta',type=str)
