...
- Illumina paired-end sequencing will generate two seuencing reads for every DNA molecule that was wucessfully sequenced. These reads will be split in two files (R1 and R2) that are analysed together.
...
- [Example FastQC Output](https://github.com/felipehcoutinho/ICM_Code/blob/main/Tutorials_and_Courses/Data/Unknown_BL327-0030008_1_fastqc.html)
